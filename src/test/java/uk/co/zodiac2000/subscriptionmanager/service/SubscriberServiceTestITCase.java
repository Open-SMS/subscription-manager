...
public class SubscriberServiceTestITCase extends AbstractTransactionalTestNGSpringContextTests {
    ...
    /**
     * Test getSubscriberByOidcIdentifier when one matching subscriber is found.
     */
    @Test
    public void testGetSubscriberByOidcIdentifier() {
        OidcIdentifierRequestDto requestDto = new OidcIdentifierRequestDto("https://www.facebook.com", "23987283");
        Set<SubscriberResponseDto> responseDtos = this.subscriberService.getSubscriberByOidcIdentifier(requestDto);

        assertThat(responseDtos, contains(
                allOf(
                        hasProperty("id", is(100000001L)),
                        hasProperty("subscriberName", is("Daphne Oram")),
    ...
    /**
     * Test getSubscriberByOidcIdentifier when multiple matching subscribers are found.
     */
    @Test
    public void testGetSubscriberByOidcIdentifierMultiple() {
        OidcIdentifierRequestDto requestDto = new OidcIdentifierRequestDto("https://www.facebook.com", "1241482");
        Set<SubscriberResponseDto> responseDtos = this.subscriberService.getSubscriberByOidcIdentifier(requestDto);

        assertThat(responseDtos, containsInAnyOrder(
                allOf(
                        hasProperty("id", is(100000006L)),
                        hasProperty("subscriberName", is("Klaus Schulze")),
                        hasProperty("samlIdentifiers", empty()),
                        hasProperty("oidcIdentifiers", contains(
                                allOf(
                                        hasProperty("issuer", is("https://www.facebook.com")),
                                        hasProperty("subject", is("1241482"))
                                )
                        ))
                ),
                allOf(
                        hasProperty("id", is(100000007L)),
                        hasProperty("subscriberName", is("Klaus Schulze (work)")),
                        hasProperty("samlIdentifiers", empty()),
                        hasProperty("oidcIdentifiers", contains(
                                allOf(
                                        hasProperty("issuer", is("https://accounts.google.com")),
                                        hasProperty("subject", is("9348"))
                                ),
                                allOf(
                                        hasProperty("issuer", is("https://www.facebook.com")),
                                        hasProperty("subject", is("1241482"))
    ...
    /**
     * Test getSubscriberByOidcIdentifier when zero matching subscribers are found.
     */
    @Test
    public void testGetSubscriberByOidcIdentifierNone() {
        OidcIdentifierRequestDto requestDto = new OidcIdentifierRequestDto("https://www.facebook.com", "924");
        Set<SubscriberResponseDto> responseDtos = this.subscriberService.getSubscriberByOidcIdentifier(requestDto);
