        ...
        assertThat(responseDto.get(), is(
                allOf(
                        ...
                        hasProperty("subscriptionContent", allOf(
                                ...
                                hasProperty("contentIdentifiers", contains(is("MUSIC"))),
        ...
        assertThat(responseDto.get(), is(
                allOf(
                        ...
                        hasProperty("subscriptionContent", allOf(
                                ...
                                hasProperty("contentIdentifiers", contains(is("EXAMPLE-ONE"), is("EXAMPLE-TWO"))),
                                hasProperty("subscriptionResource", allOf(
                                        hasProperty("id", is(100000001L)),
        ...
        assertThat(responseDto.get(), is(
                allOf(
                        ...
                        hasProperty("subscriptionContent", allOf(
                                ...
                                hasProperty("contentIdentifiers", contains(is("ECONOMICS"))),
                                hasProperty("subscriptionResource", allOf(
                                        hasProperty("id", is(100000003L)),
